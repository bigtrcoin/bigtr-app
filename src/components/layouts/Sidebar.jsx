      ...
      >
        <button className="w-full h-full flex items-center justify-center">
          <div className="flex flex-col items-center w-6 h-6">
            <div className="h-3 w-1 rounded-full duration-200" style={togglerUpStyle}></div>
            <div className="h-3 w-1 rounded-full duration-200" style={togglerDownStyle}></div>
          </div>
        </button>
      </div>
      <div
            ...
            >
              ...
              <ul className="p-3.75 hidden xl:flex flex-col gap-1.25 sidebar-menu">
                {sidebarMenu?.map((menuItem, mid) => {
                  ...
                  return (
                    <li key={mid}>
                      <NavLink to={menuItem.url} className="w-fit group flex items-center">
              ...
              <ul className="p-3.75 pt-2 flex flex-col gap-1 xl:hidden">
                {sidebarMenu?.map((menuItem, mid) => {
                  ...
                  return (
                    <li key={mid}>
                      <NavLink to={menuItem.url} className="group flex items-center">
